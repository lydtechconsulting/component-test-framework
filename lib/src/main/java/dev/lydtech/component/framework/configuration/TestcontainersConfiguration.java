...
public final class TestcontainersConfiguration {
    ...
    public static List<AdditionalContainer> parseAdditionalContainers() {
    ...
    public static List<String> parseKafkaTopics() {
    ...
    static {
        log.info("Component Test Framework Configuration:");
