...
| postgres.schema.file.path                       | The path to the file containing the schema initialisation SQL.  e.g. `src/test/resources/schema.sql`                                                                                                                                                                                                                                                                            |                                           |
...
A SQL file can be run when the database container is started for the initial database population.  Specify the path to the SQl file to use with the `postgres.schema.file.path` property.

e.g. `-Dpostgres.schema.file.path=src/test/resources/schema.sql`
