...
| service.application.yml.path                    | Path to the Spring Application config file (yml forma for the service under test                                                                                                                                                                                                                                                                                                | ./target/test-classes/application-component-test.yml |
